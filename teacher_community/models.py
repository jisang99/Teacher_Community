...
class Post(models.Model):
    author = models.ForeignKey(
        Teacher, related_name="post_author", on_delete=models.CASCADE
    )
...
class Comment(models.Model):
    ...
    author = models.ForeignKey(
        Teacher, related_name="comment_author", on_delete=models.CASCADE
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class AttachedFile(models.Model):
    post = models.ForeignKey(
        Post, related_name="AttachedFile_post", on_delete=models.CASCADE
    )
