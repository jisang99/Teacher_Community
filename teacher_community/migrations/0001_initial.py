    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_post', to='teacher_community.post')),
            ],
        ),
        migrations.CreateModel(
            name='AttachedFile',
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AttachedFile_post', to='teacher_community.post')),
            ],
        ),
    ]
